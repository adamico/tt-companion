...
public class ModJigsawPlacement extends JigsawPlacement {
    static final Logger LOGGER = LogUtils.getLogger();

    public static @NotNull Optional<Structure.GenerationStub> addPieces(
    ...
    private static void addPieces(
        ...
        ModJigsawPlacement.Placer jigsawplacement$placer = new ModJigsawPlacement.Placer(pools, maxDepth, chunkGenerator, structureTemplateManager, pieces, random);
        ...
        while (jigsawplacement$placer.placing.hasNext()) {
            ModJigsawPlacement.PieceState jigsawplacement$piecestate = jigsawplacement$placer.placing.next();
                                        ...
                                        if (JigsawBlock.canAttach(structuretemplate$structureblockinfo, structuretemplate$structureblockinfo1)) {
                                            ...
                                            if (!Shapes.joinIsNotEmpty(
                                                ...
                                                if (depth + 1 <= this.maxDepth) {
                                                    ModJigsawPlacement.PieceState jigsawplacement$piecestate = new ModJigsawPlacement.PieceState(
