...
public class QuarryStructure extends Structure {
     ...
     * Then loop through it and look for land with air above it and set blockpos Y value to it.
     * Make sure to set the final boolean in JigsawPlacement.addPieces to false so
     * that the structure spawns at blockpos y value instead of placing the structure on the Bedrock roof!
     *
    ...
    @Override
    protected Optional<GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        Optional<Structure.GenerationStub> structurePiecesGenerator =
                JigsawPlacement.addPieces(
                        ...
                        this.size, // How deep a branch of pieces can go away from centerpiece. (5 means branches cannot be longer than 5 pieces from center piece)
                        ...
                        // Here, blockpos y value is 60 which means the structure spawn 60 blocks above terrain height.
